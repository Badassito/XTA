...
class PackageMetadataTests(unittest.TestCase):
    ...
    def test_project_metadata_uses_mode_dispatcher(self) -> None:
        ...
        self.assertIn('"TTA_EXTERNAL_AUGMENTATION.md"', data_files)
        self.assertIn('"PROJECTION_SAMPLING.md"', data_files)
    ...
    def test_source_distribution_has_one_versioned_launcher(self) -> None:
        ...
        self.assertIn("include PROJECTION_SAMPLING.md", manifest_lines)
